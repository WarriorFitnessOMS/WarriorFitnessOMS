...
const WhyUs = () => {
  ...
  return (
    <section className="w-full py-20 px-4 md:px-6 bg-orange-500">
      {/* HEADING */}
      <motion.div
      ...
      >
        <motion.h2
          className="text-5xl md:text-6xl font-bold font-BabesNeue text-black mb-4"
          initial={{ opacity: 0 }}
        ...
        <motion.p
          className="text-xl md:text-2xl font-medium text-white tracking-wider"
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
      ...
      >
        {whyUsData.map((item) => {
          ...
          return (
            ...
            >
              <motion.div
                className="h-full flex flex-col items-center text-center p-8 rounded-lg bg-black/40 backdrop-blur-sm border-2 border-black hover:border-orange-400 transition-all duration-300 cursor-pointer"
                whileHover={{ 
                  y: -10,
              ...
              >
                {/* ICON CIRCLE */}
                <motion.div
                  className="w-24 h-24 p-2 rounded-full bg-black flex items-center justify-center mb-6"
                ...
                {/* TITLE */}
                <motion.h3
                  className="text-white text-3xl mb-3 font-BabesNeue tracking-wide"
                  initial={{ opacity: 0 }}
                  whileInView={{ opacity: 1 }}
